...
<script src="${rootRel}kdl-site-header.js" defer></script>
<style>
...
function productFaqs(cat, product) {
  ...
  return [
    ...
    { q: '¿Puedo solicitar ficha técnica, manual o diagrama?', a: 'Sí. Indica la marca y el modelo exactos para localizar la documentación oficial correspondiente.' }
  ];
}
